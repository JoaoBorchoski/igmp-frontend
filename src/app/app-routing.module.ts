...
const routes: Routes = [
	{
		...
		children: [
			...
			},
			{
				path: "block-reasons",
				loadChildren: () =>
					import("./modules/security/block-reasons/block-reasons.module").then((m) => m.BlockReasonsModule),
			},
			{
				path: "user-groups",
				loadChildren: () =>
					import("./modules/security/user-groups/user-groups.module").then((m) => m.UserGroupsModule),
			},
			{
				path: "users",
			...
			},
			{
				path: "menu-options",
				loadChildren: () =>
					import("./modules/security/menu-options/menu-options.module").then((m) => m.MenuOptionsModule),
			},
			{
				path: "profiles",
			...
			},
			{
				...
				loadChildren: () =>
					import("./modules/security/profile-options/profile-options.module").then(
			...
			},
			{
				path: "users-profiles",
				loadChildren: () =>
					import("./modules/security/users-profile/users-profile.module").then((m) => m.UsersProfileModule),
			},
			{
				path: "navigations",
				loadChildren: () =>
					import("./modules/security/navigations/navigations.module").then((m) => m.NavigationsModule),
			},
			{
				path: "paises",
			...
			},
			{
				path: "funcionarios",
				loadChildren: () =>
					import("./modules/configuracao/funcionario/funcionario.module").then((m) => m.FuncionarioModule),
			},
			{
				path: "clientes",
				loadChildren: () =>
					import("./modules/configuracao/cliente/cliente.module").then((m) => m.ClienteModule),
			},
			{
				path: "padroes-cores",
				loadChildren: () =>
			...
			},
			{
				...
				loadChildren: () =>
					import("./modules/configuracao/sentido-abertura/sentido-abertura.module").then(
						(m) => m.SentidoAberturaModule
					),
			},
			{
				path: "espelhos-carga",
				loadChildren: () =>
					import("./modules/configuracao/tipo-porta/tipo-porta.module").then((m) => m.TipoPortaModule),
			},
			{
				path: "fechaduras",
				loadChildren: () =>
					import("./modules/configuracao/fechadura/fechadura.module").then((m) => m.FechaduraModule),
			},
			{
				path: "alizares",
			...
			},
			{
				path: "larguras-vaos",
				loadChildren: () =>
					import("./modules/configuracao/largura-vaos/largura-vaos.module").then((m) => m.LarguraVaosModule),
			},
			{
				path: "alturas-vaos",
				loadChildren: () =>
					import("./modules/configuracao/altura-vaos/altura-vaos.module").then((m) => m.AlturaVaosModule),
			},
			{
				path: "status-negociacoes",
				loadChildren: () =>
					import("./modules/configuracao/status-negociacao/status-negociacao.module").then(
						(m) => m.StatusNegociacaoModule
					),
			},
			{
				path: "pedidos",
			...
			},
			{
				path: "pedidos-items",
				loadChildren: () =>
					import("./modules/operacao/pedido-item/pedido-item.module").then((m) => m.PedidoItemModule),
			},
			{
				path: "pacotes",
			...
			// },
			{
				path: "cadastro-obras",
				loadChildren: () =>
					import("./modules/operacao/cadastro-obra/cadastro-obra.module").then((m) => m.CadastroObraModule),
			},
			{
				path: "medicoes",
			...
			},
			{
				path: "negociacoes",
				loadChildren: () =>
					import("./modules/operacao/negociacao/negociacao.module").then((m) => m.NegociacaoModule),
			},
		],
	},
	{
