...
export class FuncionarioEditComponent implements OnInit, OnDestroy {
  ...
  public paisIdService = `${environment.baseUrl}/paises/select`
  ...
  getLiterals() {
    this.languagesService.getLiterals({ type: 'edit', module: 'configuracao', options: 'funcionario'})
      .subscribe({
  ...
  markAsDirty() {
    ...
    this.funcionarioForm.controls.cpf.markAsDirty()
    this.funcionarioForm.controls.email.markAsDirty()
  }
