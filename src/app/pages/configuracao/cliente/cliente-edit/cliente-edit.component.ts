...
export class ClienteEditComponent implements OnInit, OnDestroy {
  ...
  getLiterals() {
    this.languagesService.getLiterals({ type: 'edit', module: 'configuracao', options: 'cliente'})
      .subscribe({
  ...
  markAsDirty() {
    ...
    this.clienteForm.controls.cpf.markAsDirty()
    this.clienteForm.controls.email.markAsDirty()
  }
